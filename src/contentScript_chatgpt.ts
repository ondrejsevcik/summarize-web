import { changeProseMirrorValue, changeTextareaValue, simulateFileSelection } from "./dom-utils.js";
import { ACTION_SUMMARIZE_PAGE, ACTION_SUMMARIZE_YOUTUBE, Page, Youtube } from "./types.js";
...
browserAPI.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  querySelectorPromise(".ProseMirror")
    .then(async (textarea) => {
      ...
      const submitButton = document.querySelector<HTMLButtonElement>("[aria-label='Send prompt']");
      submitButton?.click();
